...
<!-- Mirrored from somia.netlify.app/index-demo-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Dec 2020 10:32:00 GMT -->
...
<head>
    ...
    <!-- Title -->
    <title>Somia - Multipurpose Template</title>

    <!-- Favicon -->
    <link rel="icon" href="img/bg-img/full-logo.png">
...
<body class="darker-blue">
        ...
        <div class="classy-nav-container breakpoint-off">
            <div class="container">
                ...
                <nav class="classy-navbar justify-content-between" id="dreamNav">
                    ...
                    <!-- Logo -->
                    <a class="nav-brand bg-dangerx" style="width: 20%;" href="#"><img src="img/bg-img/full-logo.png" style="max-width: 100%;" alt="logo"></a>
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav ">
                            <ul id="nav">
                                ...
                                <li><a href="#roadmap">Token</a></li>
                                <!-- <li><a href="#roadmap">Roadmap</a></li> -->
                                <li><a href="#contact">Lead Stake</a></li>
                                <li><a href="#contact">Lead Wallet</a></li>
                ...
                <div class="row h-100 align-items-center">
                    ...
                    <div class="col-12 col-lg-6 col-md-12">
                        <div class="welcome-content">
                            ...
                            <h1 class="wow fadeInUp" data-wow-delay="0.2s">WORLD'S SIMPLEST CRYPTO WALLET AND DEFI ACCESS</h1>
                            <small>STORE, SPEND, SWAP, STAKE</small>
                            <p class="wow fadeInUp" data-wow-delay="0.3s">We are not trying to reinvent the wheel. We are not trying to create a new blockchain ecosystem that nobody would use. We understand the biggest problem with cryptocurrency adoption is the lack of user-friendly and beautifully-designed applications.</p>
                            <div class="dream-btn-group wow fadeInUp" data-wow-delay="0.4s">
                                <a href="https://info.uniswap.org/token/0x1dd80016e3d4ae146ee2ebb484e8edd92dacc4ce" target="_blank" class="btn dream-btn mr-3">UNISWAP</a>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    <div class="welcome-meter wow fadeInUp" data-wow-delay="0.7s">
                        <img src="img/svg/about1.svg" class="img-responsive center-block" alt="">
                        <!-- client meta -->
    ...
    <section class="about-us-area section-padding-0-100 clearfix">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    <div class="welcome-meter wow fadeInUp" data-wow-delay="0.7s">
                        <img src="img/bg-img/ecosystem.png" class="center-block" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1 col-sm-12">
                <div class="welcome-video-area wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="video-icon">
                        <a href="https://www.youtube.com/watch?v=ML7uOJAETpc&feature=youtu.be&ab_channel=LeadWallet" class="btn dream-btn video-btn" id="videobtn"><i class="fa fa-play"></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="roadmap" style="padding-bottom:0; background: url('img/bg-img/nosiy.png'); " id="roadmap" >
        <div class="section-heading text-center">
            <!-- Dream Dots -->
            <div class="dream-dots justify-content-center wow fadeInUp" data-wow-delay="0.2s">
                <span></span><span></span><span></span><span></span><span></span><span></span><span></span>
            ...
            <div class="row">
                <div class="col-lg-2 col-sm-6">
                    <div class="partner-box">
                        <img src="img/partners/1.png" alt="" class="center-bock">
                    </div>
                </div>
                <div class="col-lg-2 col-sm-6">
                    <div class="partner-box">
                        <img src="img/partners/2.png" alt="" class="center-bock">
                    </div>
                </div>
                <div class="col-lg-2 col-sm-6">
                    <div class="partner-box">
                ...
                <div class="col-lg-2 col-sm-6">
                    <div class="partner-box">
                        <img src="img/partners/8.png" alt="" class="center-bock">
                    </div>
                </div>
                <div class="col-lg-2 col-sm-6">
                    <div class="partner-box">
                        <img src="img/partners/9.png" alt="" class="center-bock">
                    </div>
                </div>
                <div class="col-lg-2 col-sm-6">
                    <div class="partner-box">
                        <img src="img/partners/10.png" alt="" class="center-bock">
                    </div>
                </div>
                <div class="col-lg-2 col-sm-6">
                    <div class="partner-box">
                        <img src="img/partners/11.png" alt="" class="center-bock">
                    </div>
                </div>
                <div class="col-lg-2 col-sm-6">
                    <div class="partner-box">
                        <img src="img/partners/12.png" alt="" class="center-bock">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="footer-copywrite-info">
                            ...
                            <div class="copywrite_text wow fadeInUp" data-wow-delay="0.2s">
                                <div class="footer-logo">
                                    <a href="#"><img src="img/core-img/logo.png" alt="logo"> Somia.</a>
                                </div>
...
<!-- Mirrored from somia.netlify.app/index-demo-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Dec 2020 10:32:24 GMT -->
</html>